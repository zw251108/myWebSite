...
<?php require_once('header.php');?>
	...
	<a href="">
    <section class="module module-metro module-small module-user">
        <h2 class="module_title">用户中心 user</h2>
    </section>
	</a>
...
<!--</a>-->
	...
	<a href="favorite">
	<section class="module module-metro module-big module-favor">
